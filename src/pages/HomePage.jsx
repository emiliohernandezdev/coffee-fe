...
import { Container, Typography, Grid, Button, Box, Card, CardContent, CardMedia, IconButton, Avatar, TextField, Snackbar, Alert} from '@mui/material';
...
const HomePage = () => {
  ...
  // Validacion de datos con snackbar form contacto
...
// Fin de la funcion validacion de datos con snackbar
  return (
    <div>
      {/* Hero Section */}
        ...
        <Container>
          ...
          <Grid container spacing={4} justifyContent="center">
            <Grid item xs={12} md={6}>
              ...
              >
                <ContactMailIcon fontSize="large" style={{ color: theme.palette.primary.main, marginBottom: '1rem' }} />
                <Typography variant="h6" className="text-xl font-semibold mb-4" style={{ color: theme.palette.text.primary }}>
                  ¡Contáctanos!
                </Typography>
                <Typography variant="body2" style={{ color: theme.palette.text.secondary, marginBottom: '2rem' }}>
                ...
                <TextField
                  ...
                  InputProps={{
                    startAdornment: (
                      <IconButton style={{ alignSelf: 'flex-start', marginTop: '-5px', marginLeft: '-5px' }}>
                        <SmsIcon />
                      </IconButton>
                    ),
                  }}
